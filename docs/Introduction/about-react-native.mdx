...
As of 2023, the number of smartphone users worldwide has continued to increase and currently stands at around 4.6 billion people, which translates to over 58% of the global population owning a smartphone. The two major operating systems in the smartphone market are Android and iOS, which continue to dominate the market share. [Android and iOS market share](gs.statcounter.com/os-market-share/mobile/worldwide) clearly in the lead.
