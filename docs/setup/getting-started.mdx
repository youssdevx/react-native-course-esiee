...
### Follow React Native documentation
...
### Install VSCode (or another editor)
...
<img alt="Expo hello world" src="/img/expo-init.png" style={{width:"50%"}} />
...
<img alt="Expo hello world" src="/img/expo-folder.png" style={{width:"50%"}} />
